...
let StatsCard2Component = class StatsCard2Component {
    constructor() { }
    ngOnInit() {
    }
};
...
let Profile1Component = class Profile1Component {
    constructor() {
        this.imagesBasic = [
            {
...
/* harmony import */ var ngx_paypal__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ngx-paypal */ "./node_modules/ngx-paypal/fesm2015/ngx-paypal.js");
...
let CheckoutNavbarComponent = class CheckoutNavbarComponent {
...
CheckoutNavbarComponent.ctorParameters = () => [
...
let PaypalCheckoutComponent = class PaypalCheckoutComponent {
    constructor(router, checkoutService) {
        this.router = router;
...
PaypalCheckoutComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let FiltersComponent = class FiltersComponent {
    constructor(departmentService, categoryService) {
    ...
    getDepartmenstList() {
        this.departmentService.getDepartments().subscribe(a => {
            ...
            let allDep = new src_app_models_department__WEBPACK_IMPORTED_MODULE_3__["Department"]();
    ...
    onSelectDepartment(department) {
        ...
        this.selectedCategory = 0;
        this.getCategoriesByDepartmentId();
        let filter = new src_app_models_paging__WEBPACK_IMPORTED_MODULE_2__["Paging"]();
...
let AppHeaderComponent = class AppHeaderComponent {
    constructor(dataService, customerService, router) {
...
let SmallCartComponent = class SmallCartComponent {
...
SmallCartComponent.ctorParameters = () => [
    { type: src_app_services_Shared_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
];
...
let ProductListComponent = class ProductListComponent {
    ...
    setFilters(filters) {
        ...
        let productPagingObj = new src_app_models_product_pagin_data__WEBPACK_IMPORTED_MODULE_2__["ProductPaginData"]();
    ...
    getProducts() {
        let filterObj = new src_app_models_paging__WEBPACK_IMPORTED_MODULE_3__["Paging"]();
...
let AddToCartComponent = class AddToCartComponent {
    constructor(productService, toastr, dataService) {
        this.productService = productService;
        this.toastr = toastr;
        this.dataService = dataService;
    }
...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, router, customerService) {
...
let RegisterComponent = class RegisterComponent {
    constructor(shippingService, formBuilder, customerService, router) {
...
let CheckoutService = class CheckoutService {
    ...
    CreatePaypalTransacton(orderDetail) {
        //This is from backend (nodejs port 8080)
        const baseUrl = 'http://localhost:8080/api/';
...
let ProductService = class ProductService {
    ...
    geProductByDepartmentId(paging) {
